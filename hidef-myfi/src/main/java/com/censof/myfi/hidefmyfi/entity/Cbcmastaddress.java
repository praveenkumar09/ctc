...
/**
 * The persistent class for the cbcmastaddress database table.
 * 
 */
@Entity
@NamedQuery(name="Cbcmastaddress.findAll", query="SELECT c FROM Cbcmastaddress c")
public class Cbcmastaddress implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private CbcmastaddressPK id;
	...
	public Cbcmastaddress() {
	}

	public CbcmastaddressPK getId() {
		return this.id;
	}

	public void setId(CbcmastaddressPK id) {
		this.id = id;
	}
