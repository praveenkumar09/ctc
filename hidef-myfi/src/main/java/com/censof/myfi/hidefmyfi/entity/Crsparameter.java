...
/**
 * The persistent class for the crsparameter database table.
 * 
 */
@Entity
@NamedQuery(name="Crsparameter.findAll", query="SELECT c FROM Crsparameter c")
public class Crsparameter implements Serializable {
	...
	@Temporal(TemporalType.TIMESTAMP)
	private Date packageProcessDate;
	...
	public Date getPackageProcessDate() {
		return this.packageProcessDate;
	}

	public void setPackageProcessDate(Date packageProcessDate) {
		this.packageProcessDate = packageProcessDate;
	}
