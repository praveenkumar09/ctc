...
public class CrsUserProfileController {
	...
	@RequestMapping(value ="/admin/crs/crsuserprofile", method = RequestMethod.GET)
	public String getUserProfile(@ModelAttribute("hidef")HidefVo hidef, 
		...
		return "crsUserProfile";
	}
	
	@GetMapping(value ="/admin/crs/loadReceivingCountryList",consumes="application/json")
	@ResponseBody
	...
	@PostMapping(value ="/admin/crs/insertReceivingCountryGrid",consumes="application/json")
	@ResponseBody
	...
	@PostMapping(value ="/admin/crs/updateReceivingCountryGrid",consumes="application/json")
	@ResponseBody
	...
	@PostMapping(value ="/admin/crs/deleteReceivingCountryGrid",consumes="application/json")
	@ResponseBody
	...
	@RequestMapping(value ="/admin/crs/profile", method = RequestMethod.POST)
	...
	@RequestMapping(value ="/admin/crs/import/excel", method = RequestMethod.POST)
