...
public interface ISigner extends ISignerNonXml, ISignerExtra {
    ...
    public boolean signXmlFileStreaming(String infile, String outfile, PrivateKey sigkey, X509Certificate sigPubCert, X509Certificate receiverPublicCert) throws Exception;
