...
/**
 * The persistent class for the cbcmnecontact database table.
 * 
 */
@Entity
@NamedQuery(name="Cbcmnecontact.findAll", query="SELECT c FROM Cbcmnecontact c")
public class Cbcmnecontact implements Serializable {
