...
/*	public ArrayList<String> unpack(String idesPkgFile, String keystoreType, String keystoreFile, String keystorePwd, String keyPwd, 
	...
	//public ArrayList<String> unpack(String idesPkgFile, PublicKey receiverPrivateKey , String targetPath , String  fileSource) throws HiDEFException, Exception;
...
//	public String createPkgWithApproverHidef(String signedXmlFile, String senderGiin, String receiverGiin, X509Certificate receiverPublicCert, 
//			String approverGiin, X509Certificate approverPublicCert, int taxyear,String myMetaXml,String targetFolderPath) throws Exception;
	public int copyFile(File file, File file2) throws  IOException;
	public void verifyAndUnsign(String string, PublicKey pubKey, String string2, boolean b);
	public int deletepkg(File file);
	public String GetXPathData(String myMetaXml, String string);
	public String getMsgRefId(String myXml, String string) throws ParserConfigurationException, SAXException, IOException;
	...
	/*public ArrayList<String> unpackForApprover(String idesPkgFile, String approverKeystoreType, String approverKeystoreFile, 
			String approverKeystorePwd, String approverKeyPwd, String approverKeyAlias , String targetPath) throws Exception;
	
	//this method unpack an IDES pkg for approver - model1 option2 
	public ArrayList<String> unpackForApprover(String idesPkgFile, PrivateKey approverPrivateKey , String targetPath) throws Exception;*/
}
