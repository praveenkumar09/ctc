	...
	<div id="crsbreadcrumb" class="crsbreadcrumb">
		<ul class="nav nav-tabs">
			...
			<li id="reportingFI"><a href="#" onclick="return false;">REPORTING
					FI</a></li>
			<li id="accountHolder"><a href="#" onclick="return false;">ACCOUNT
					HOLDER</a></li>
	...
	<div id="cbcbreadcrumb" class="cbcbreadcrumb">
		<ul class="nav nav-tabs">
			...
			<li id="reportingEntity"><a href="#" onclick="return false;">REPORTING
					ENTITY</a></li>
			<li id="cbcReports"><a href="#" onclick="return false;">CBC
					REPORTS</a></li>
			<li id="cbcAddInfo"><a href="#" onclick="return false;">ADDITIONAL
					INFO</a></li>
			<!-- <li id="config"><a href="#" onclick="showConfig();">CONFIGURATION</a></li> -->
		</ul>
		<input type="hidden" name="${_csrf.parameterName}"
			value="${_csrf.token}" /> <input type="hidden" id="toProfilePage"
			value='${toProfilePage}' /> <input type="hidden" id="toProfilePage"
			value='${toCRSProfilePage}' />
		<div id="tabinfo"></div>
	</div>
	...
	<div class="modal fade" id="importpopup" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<form:form modelAttribute="hidef" enctype="multipart/form-data"
				action="import/excel" id="importExcel" method="POST">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button type="button" onClick="onClickImportExcelCalled();"
